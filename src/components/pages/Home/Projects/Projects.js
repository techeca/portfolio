...
export default function Projects(){
  ...
  return(
    ...
    <section className="bg-gray-50 dark:bg-neutral-900 h-full">
      ...
      <div className="grid gap-8 lg:grid-cols-3 md:grid-cols-2 sm:p-4 bg-gray-50 dark:bg-neutral-900">

          <motion.div  whileHover={{ scale: 1.05 }} transition={{ type: "spring", stiffness: 400, damping: 10 }}>
            <article onClick={() => openModalProj('pokeAppModal')} className="p-6 h-80 grid bg-white rounded-lg shadow-md dark:bg-neutral-800 cursor-pointer hover:bg-gray-100 dark:hover:bg-neutral-700 select-none">
          ...
          <motion.div  whileHover={{ scale: 1.05 }} transition={{ type: "spring", stiffness: 400, damping: 10 }} whileTap={{ scale: 1 }}>
            <article onClick={() => openModalProj('folderAppModal')} className="grid h-80 p-6 bg-white rounded-lg shadow-md dark:bg-neutral-800 cursor-pointer hover:bg-gray-100 dark:hover:bg-neutral-700 select-none" >
          ...
          <motion.div whileHover={{ scale: 1.05 }} transition={{ type: "spring", stiffness: 400, damping: 10 }} whileTap={{ scale: 1 }}>
              <article onClick={() => openModalProj('pokeggModal')} className="p-6 h-80 grid bg-white rounded-lg  shadow-md dark:bg-neutral-800 cursor-pointer hover:bg-gray-100 dark:hover:bg-neutral-700 select-none">
          ...
          <motion.div  whileHover={{ scale: 1.05 }} transition={{ type: "spring", stiffness: 400, damping: 10 }} whileTap={{ scale: 1 }}>
              <article onClick={() => openModalProj('crawlasModal')} className="p-6 h-80 grid bg-white rounded-lg shadow-md dark:bg-neutral-800 cursor-pointer hover:bg-gray-100 dark:hover:bg-neutral-700 select-none">
                ...
                <div className="flex flex-row gap-1 lg:grid-cols-2 flex justify-around items-center text-gray-500">
                  ...
                  <img src={logoPuppeteer} className="h-10" alt="Taildwind Logo" />
          ...
          <motion.div  whileHover={{ scale: 1 }} transition={{ type: "spring", stiffness: 400, damping: 10 }} whileTap={{ scale: 1 }}>
              <article className=" opacity-50 p-6 h-80 border border-neutral-600 grid bg-white rounded-lg dark:bg-neutral-800 select-none">
                ...
                <div className="flex flex-row gap-1 lg:grid-cols-2 flex justify-around items-center text-gray-500">
                  ...
                  <i className="text-3xl fa-brands fa-js text-yellow-200"></i>
                  <img src={logoMysql} className="h-8 ml-2" alt="MYSQL Logo" />
          ...
          {/*<motion.div  whileHover={{ scale: 1.05 }} transition={{ type: "spring", stiffness: 400, damping: 10 }} whileTap={{ scale: 1 }}>
              <article onClick={() => openModalProj('crawlasModal')} className="p-6 h-80 grid bg-white rounded-lg shadow-md dark:bg-neutral-800 cursor-pointer hover:bg-gray-100 dark:hover:bg-neutral-700 select-none">
                <h2 className="mb-2 text-2xl font-bold tracking-tight text-gray-900 dark:text-white"><p>CriptoBros</p></h2>
                <p className="font-light text-gray-500 dark:text-gray-400">Consume API de Coingecko para listar Tokens y Exchanges</p>
                <div className="flex flex-row gap-1 lg:grid-cols-2 flex justify-around items-center text-gray-500">
          ...
          <div id="pokeAppModal" tabIndex="-1" aria-hidden="true" className="hidden flex justify-center items-center overflow-y-auto overflow-x-hidden fixed top-0 right-0 left-0 z-50 w-full md:inset-0 h-modal md:h-full" style={{background: "rgba(26, 26, 26, 0.8)"}}>
            ...
            <div className="relative p-4 w-full max-w-2xl h-full md:h-auto">
                ...
                <div className="relative bg-white rounded-lg shadow dark:bg-neutral-800 border dark:border-neutral-600">
                    ...
                    <div className="flex justify-between items-start p-4 rounded-t border-b dark:border-gray-600">
                        ...
                        <button type="button" onClick={() => openModalProj('pokeAppModal')} className=" text-gray-400 bg-transparent hover:bg-gray-200 hover:text-gray-900 rounded-lg text-sm p-1.5 ml-auto inline-flex items-center dark:hover:bg-gray-600 dark:hover:text-white">
          ...
          <div id="folderAppModal" tabIndex="-1" className="hidden flex justify-center items-center overflow-y-auto overflow-x-hidden fixed top-0 right-0 left-0 z-50 w-full md:inset-0 h-modal md:h-full" style={{background: "rgba(26, 26, 26, 0.8)"}}>
            ...
            <div className="relative p-4 w-full max-w-2xl h-full md:h-auto">
                ...
                <div className="relative bg-white rounded-lg shadow dark:bg-neutral-800 border dark:border-neutral-600">
                    ...
                    <div className="flex justify-between items-start p-4 rounded-t border-b dark:border-gray-600">
                        ...
                        <button type="button" onClick={() => openModalProj('folderAppModal')} className=" text-gray-400 bg-transparent hover:bg-gray-200 hover:text-gray-900 rounded-lg text-sm p-1.5 ml-auto inline-flex items-center dark:hover:bg-gray-600 dark:hover:text-white">
                            <svg aria-hidden="true" className="w-5 h-5 text-gray-400 dark:text-gray-50" stroke="currentColor" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg"><path fillRule="evenodd" d="M4.293 4.293a1 1 0 011.414 0L10 8.586l4.293-4.293a1 1 0 111.414 1.414L11.414 10l4.293 4.293a1 1 0 01-1.414 1.414L10 11.414l-4.293 4.293a1 1 0 01-1.414-1.414L8.586 10 4.293 5.707a1 1 0 010-1.414z" clipRule="evenodd"></path></svg>
                            <span className="sr-only">Close modal</span>
                        </button>
                    </div>
                    ...
                    <div className="mb-4 border-b border-gray-200 dark:border-gray-800">
                        <ul className="mx-4 flex flex-wrap -mb-px text-sm font-medium text-center" id="myTab2" data-tabs-toggle="#tabContentFolderApp" role="tablist">
                            <li className="mr-2" role="presentation">
                                <button className="inline-block p-4 rounded-t-lg border-b-2 text-blue-600 hover:text-blue-600 dark:text-blue-500 dark:hover:text-blue-500 border-blue-600 dark:border-blue-500" id="tabpanelfolderApp" data-tabs-target="#details2" type="button" role="tab" aria-controls="profile" aria-selected="true">
                                Detalles</button>
                            </li>
                            <li className="mr-2" role="presentation">
                                <button className="inline-block p-4 rounded-t-lg border-b-2 border-transparent hover:text-gray-600 hover:border-gray-300 dark:hover:text-gray-300 dark:border-transparent text-gray-500 dark:text-gray-400 border-gray-100 dark:border-gray-700" id="imagesfolderapp" data-tabs-target="#images2" type="button" role="tab" aria-controls="images" aria-selected="false">
                                Imagenes</button>
                            </li>
                        </ul>
                    </div>
                    ...
                    <div id="tabContentFolderApp">
                        ...
                        <div className="p-4 m-4 bg-gray-50 rounded-lg dark:bg-neutral-700" id="details2" role="tabpanel" aria-labelledby="tabpanelfolderApp">
                        ...
                        <div className="hidden p-4 bg-gray-50 rounded-lg dark:bg-neutral-800" id="images2" role="tabpanel" aria-labelledby="imagesfolderapp">
          ...
          <div id="pokeggModal" tabIndex="-1" aria-hidden="true" className="hidden flex justify-center items-center overflow-y-auto overflow-x-hidden fixed top-0 right-0 left-0 z-50 w-full md:inset-0 h-modal md:h-full" style={{background: "rgba(26, 26, 26, 0.8)"}}>
            ...
            <div className="relative p-4 w-full max-w-2xl h-full md:h-auto">
                ...
                <div className="relative bg-white rounded-lg shadow dark:bg-neutral-800 border dark:border-neutral-600">
                    ...
                    <div className="flex justify-between items-start p-4 rounded-t border-b dark:border-gray-600">
                        ...
                        <button type="button" onClick={() => openModalProj('pokeggModal')} className=" text-gray-400 bg-transparent hover:bg-gray-200 hover:text-gray-900 rounded-lg text-sm p-1.5 ml-auto inline-flex items-center dark:hover:bg-gray-600 dark:hover:text-white">
                            <svg aria-hidden="true" className="w-5 h-5 text-gray-400 dark:text-gray-50" stroke="currentColor" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg"><path fillRule="evenodd" d="M4.293 4.293a1 1 0 011.414 0L10 8.586l4.293-4.293a1 1 0 111.414 1.414L11.414 10l4.293 4.293a1 1 0 01-1.414 1.414L10 11.414l-4.293 4.293a1 1 0 01-1.414-1.414L8.586 10 4.293 5.707a1 1 0 010-1.414z" clipRule="evenodd"></path></svg>
                            <span className="sr-only">Close modal</span>
                        </button>
                    </div>
          ...
          <div id="crawlasModal" tabIndex="-1" aria-hidden="true" className="hidden flex justify-center items-center overflow-y-auto overflow-x-hidden fixed top-0 right-0 left-0 z-50 w-full md:inset-0 h-modal md:h-full" style={{background: "rgba(26, 26, 26, 0.8)"}}>
            ...
            <div className="relative p-4 w-full max-w-2xl h-full md:h-auto">
                ...
                <div className="relative bg-white rounded-lg shadow dark:bg-neutral-800 border dark:border-neutral-600">
                    ...
                    <div className="flex justify-between items-start p-4 rounded-t border-b dark:border-gray-600">
                        ...
                        <button type="button" onClick={() => openModalProj('crawlasModal')} className=" text-gray-400 bg-transparent hover:bg-gray-200 hover:text-gray-900 rounded-lg text-sm p-1.5 ml-auto inline-flex items-center dark:hover:bg-gray-600 dark:hover:text-white">
                            <svg aria-hidden="true" className="w-5 h-5 text-gray-400 dark:text-gray-50" stroke="currentColor" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg"><path fillRule="evenodd" d="M4.293 4.293a1 1 0 011.414 0L10 8.586l4.293-4.293a1 1 0 111.414 1.414L11.414 10l4.293 4.293a1 1 0 01-1.414 1.414L10 11.414l-4.293 4.293a1 1 0 01-1.414-1.414L8.586 10 4.293 5.707a1 1 0 010-1.414z" clipRule="evenodd"></path></svg>
                            <span className="sr-only">Close modal</span>
                        </button>
                    </div>
                    ...
                    <div className="mb-4 border-b border-gray-200 dark:border-gray-800">
                        <ul className="mx-4 flex flex-wrap -mb-px text-sm font-medium text-center" id="myTabpokegg" data-tabs-toggle="#tabContentPokEgg" role="tablist">
                            <li className="mr-2" role="presentation">
                                <button className="inline-block p-4 rounded-t-lg border-b-2 text-blue-600 hover:text-blue-600 dark:text-blue-500 dark:hover:text-blue-500 border-blue-600 dark:border-blue-500" id="tabpanel-tabcrawlas" data-tabs-target="#detailscrawlas" type="button" role="tab" aria-controls="profile" aria-selected="true">
                                Detalles</button>
                            </li>
                            <li className="mr-2" role="presentation">
            ...
            <div className="relative p-4 w-full max-w-2xl h-full md:h-auto">
                ...
                <div className="relative bg-white rounded-lg shadow dark:bg-neutral-800 border dark:border-neutral-600">
                    ...
                    <div className="mb-4 border-b border-gray-200 dark:border-gray-800">
                        <ul className="mx-4 flex flex-wrap -mb-px text-sm font-medium text-center" id="myTab2" data-tabs-toggle="#tabContentFolderApp" role="tablist">
                            <li className="mr-2" role="presentation">
                                <button className="inline-block p-4 rounded-t-lg border-b-2 text-blue-600 hover:text-blue-600 dark:text-blue-500 dark:hover:text-blue-500 border-blue-600 dark:border-blue-500" id="tabpanelbusystem" data-tabs-target="#details2" type="button" role="tab" aria-controls="profile" aria-selected="true">
                                Detalles</button>
                            </li>
                            <li className="mr-2" role="presentation">
                                <button className="inline-block p-4 rounded-t-lg border-b-2 border-transparent hover:text-gray-600 hover:border-gray-300 dark:hover:text-gray-300 dark:border-transparent text-gray-500 dark:text-gray-400 border-gray-100 dark:border-gray-700" id="imagesbusystem" data-tabs-target="#images2" type="button" role="tab" aria-controls="images" aria-selected="false">
                                Imagenes</button>
                            </li>
                        </ul>
                    </div>
                    ...
                    <div id="tabContentFolderApp">
                        ...
                        <div className="p-4 m-4 bg-gray-50 rounded-lg dark:bg-neutral-700" id="details2" role="tabpanel" aria-labelledby="tabpanelbusystem">
                          <p className='mb-6 dark:text-gray-200'>Creada con NextJS, con registros, conexión a base de datos, JWT, etc.</p>
                          <div className='grid grid-cols-2'>
                              <ul className="space-y-4 text-left dark:text-gray-200">
                                  <li className="flex items-center space-x-3">
                                      <svg className="flex-shrink-0 w-5 h-5 text-green-500 dark:text-green-400" stroke="currentColor" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg"><path fillRule="evenodd" d="M16.707 5.293a1 1 0 010 1.414l-8 8a1 1 0 01-1.414 0l-4-4a1 1 0 011.414-1.414L8 12.586l7.293-7.293a1 1 0 011.414 0z" clipRule="evenodd"></path></svg>
                        ...
                        <div className="hidden p-4 bg-gray-50 rounded-lg dark:bg-neutral-800" id="images2" role="tabpanel" aria-labelledby="imagesbusystem">
