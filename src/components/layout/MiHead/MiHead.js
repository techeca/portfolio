  ...
  return(
      <nav className="bg-white border-gray-200 px-2 md:px-4 py-2 dark:bg-neutral-900 border-b-2 dark:border-neutral-800">
          <div className="flex flex-wrap justify-between items-center mx-auto max-w-screen-xl">
              <a href="#formContacto" className="flex items-center text-xl font-semibold dark:text-gray-300">
                  {/*<img src="https://flowbite.com/docs/images/logo.svg" className="mr-3 h-6 sm:h-9" alt="Flowbite Logo" />*/}
                  Jim<span className="self-center text-xl font-semibold whitespace-nowrap dark:text-white">&nbsp;Vásquez</span>
              </a>
              <div className="flex items-center md:order-2">
                  ...
                  <button data-collapse-toggle="mega-menu-icons" onClick={openMegaMenu} type="button" className="inline-flex items-center p-2 ml-1 text-sm text-gray-500 rounded-lg md:hidden hover:bg-gray-100 focus:outline-none focus:ring-2 focus:ring-gray-200 dark:text-gray-400 dark:hover:bg-gray-700 dark:focus:ring-gray-600" aria-expanded="false">
              ...
              <div id="mega-menu-icons" className="justify-between items-center w-full md:flex md:w-auto md:order-2 hidden">
                  <ul className="flex flex-col mt-4 text-sm font-bold md:flex-row md:space-x-8 md:mt-0">
                      <li>
                          {/*<a href="https://github.com/techeca" className="block py-2 pr-4 pl-3 text-blue-600 border-b border-gray-100 hover:bg-gray-50 md:hover:bg-transparent md:border-0 md:hover:text-blue-600 md:p-0 dark:text-blue-500 md:dark:hover:text-blue-500 dark:hover:bg-gray-700 dark:hover:text-blue-500 md:dark:hover:bg-transparent dark:border-gray-700" aria-current="page">
                            Home
                          </a>*/}
                      </li>
                      <li>
                          {/*<button id="mega-menu-icons-dropdown-button" data-dropdown-toggle="mega-menu-icons-dropdown" className="flex justify-between items-center py-2 pr-4 pl-3 w-full font-bold text-gray-700 border-b border-gray-100 md:w-auto hover:bg-gray-50 md:hover:bg-transparent md:border-0 md:hover:text-blue-600 md:p-0 dark:text-gray-400 md:dark:hover:text-blue-500 dark:hover:bg-gray-700 dark:hover:text-blue-500 md:dark:hover:bg-transparent dark:border-gray-700">
                              Ideas
                          ...
                          <div id="mega-menu-icons-dropdown" className="grid hidden absolute z-10 grid-cols-1 w-auto text-sm bg-white rounded-lg border border-gray-100 shadow-md dark:border-gray-700 md:grid-cols-1 dark:bg-gray-700" style={{position: "absolute", inset: "0px auto auto 0px", margin: "0px", transform: "translate(0px, 520px)"}} data-popper-reference-hidden="" data-popper-escaped="" data-popper-placement="bottom">
                              <div className="p-4 pb-0 text-gray-900 md:pb-4 dark:text-white">
                                  <ul className="space-y-4" aria-labelledby="mega-menu-icons-dropdown-button">
                                      <li>
                                          <a href="https://github.com/techeca" className="flex items-center text-gray-500 dark:text-gray-400 hover:text-blue-600 dark:hover:text-blue-500 group">
                      ...
                      <li>
                          <a href="#formContacto" className="block py-2 pr-4 pl-3 text-gray-700 border-b border-gray-100 hover:bg-gray-50 md:hover:bg-transparent md:border-0 md:hover:text-blue-600 md:p-0 dark:text-gray-400 md:dark:hover:text-blue-500 dark:hover:bg-gray-700 dark:hover:text-blue-500 md:dark:hover:bg-transparent dark:border-gray-700">
                            Contacto
                          </a>
                      </li>
                  </ul>
